    ...
    <div className="min-h-screen bg-black">
              ...
              <Flex direction="col" gap={6}>
                <div className="relative mx-auto">
                  <div className="w-32 h-32 bg-gray-700 rounded-full mx-auto flex items-center justify-center">
                    <span className="text-white text-2xl md:text-3xl font-bold">DJ</span>
                  </div>
                </div>
                <Flex direction="col" gap={2}>
                  <H3>David Johnson</H3>
              ...
              <Flex direction="col" gap={6}>
                <div className="relative mx-auto">
                  <div className="w-32 h-32 bg-gray-600 rounded-full mx-auto flex items-center justify-center">
                    <span className="text-white text-2xl md:text-3xl font-bold">LC</span>
                  </div>
                </div>
                <Flex direction="col" gap={2}>
                  <H3>Lisa Chen</H3>
      ...
      <Section className="bg-black">
        <Flex direction="col" gap={8}>
          ...
          <Grid cols={4}>
            ...
            <Card hover className="p-6 text-center">
              <Flex direction="col" gap={4}>
                <div className="w-20 h-20 bg-gray-600 rounded-full mx-auto flex items-center justify-center">
                  <span className="text-white text-lg md:text-xl font-bold">AK</span>
                </div>
                <Flex direction="col" gap={1}>
                  <H4>Alex Kim</H4>
            ...
            <Card hover className="p-6 text-center">
              <Flex direction="col" gap={4}>
                <div className="w-20 h-20 bg-black0 rounded-full mx-auto flex items-center justify-center">
                  <span className="text-white text-lg md:text-xl font-bold">JS</span>
                </div>
                <Flex direction="col" gap={1}>
                  <H4>Jessica Smith</H4>
            ...
            <Card hover className="p-6 text-center">
              <Flex direction="col" gap={4}>
                <div className="w-20 h-20 bg-gray-700 rounded-full mx-auto flex items-center justify-center">
                  <span className="text-white text-lg md:text-xl font-bold">RC</span>
                </div>
                <Flex direction="col" gap={1}>
                  <H4>Ryan Chen</H4>
        ...
        <Flex direction="col" gap={8}>
          <div className="text-center">
            <Flex direction="col" gap={6}>
              ...
              <Flex gap={4} justify="center">
                <Button as={Link} href="/careers" size="lg" className="bg-black text-white hover:bg-gray-100">
                  View Open Positions
                </Button>
      ...
      <footer className="bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <Grid cols={4}>
            ...
            <div>
              ...
              <Flex direction="col" gap={2}>
                ...
                <Link href="/integrations" className="text-gray-400 hover:text-white text-sm">Integrations</Link>
              </Flex>
            </div>
            <div>
              ...
              <Flex direction="col" gap={2}>
                ...
                <Link href="/team" className="text-gray-400 hover:text-white text-sm">Team</Link>
          ...
          <div className="border-t border-gray-300 mt-8 pt-8 text-center text-sm text-gray-400">
