...
export const metadata = {
  ...
  description:
    "Read Enclosed.AI's Terms of Service to understand your rights and responsibilities when using our AI-powered direct mail marketing platform.",
};
          ...
          <Prose>
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                Enclosed.AI platform and services (collectively, the "Service")
                provided by Enclosed.AI, Inc. ("Company," "we," "our," or "us").
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Enclosed.AI provides an AI-powered direct mail marketing
                platform that enables users to create, send, and track
                personalized direct mail campaigns. Our Service includes:
              </p>
              <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                <li>AI-powered content generation and personalization</li>
                <li>Campaign management and scheduling tools</li>
                <li>Recipient list management and validation</li>
                <li>Professional printing and mailing services</li>
                <li>Analytics and performance tracking</li>
                <li>Customer support and technical assistance</li>
              </ul>
              <p className="text-gray-700 leading-relaxed">
                The Service is provided on a pay-per-use basis with no monthly
                fees or long-term commitments required.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                <li>
                  Send spam, unsolicited commercial communications, or illegal
                  content
                </li>
              ...
              <p className="text-gray-700 leading-relaxed">
                We reserve the right to monitor your use of the Service and take
                appropriate action if we detect violations of this policy.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                recipient lists, campaign content, and other materials ("Your
                Content"). By using our Service, you grant us a limited,
                non-exclusive license to use Your Content solely for the purpose
                of providing the Service to you.
              </p>
              <p className="text-gray-700 leading-relaxed mb-6">
                You represent and warrant that you have all necessary rights to
                Your Content and that it does not violate any third-party rights
                or applicable laws.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                functionality are owned by Enclosed.AI and are protected by
              ...
              <p className="text-gray-700 leading-relaxed">
                We process your data in accordance with our Privacy Policy. By
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Our Service is provided on a pay-per-use basis. Payment terms
                include:
              </p>
              <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                <li>Payment is due upon campaign submission</li>
                <li>We accept major credit cards and ACH transfers</li>
                <li>
                  All prices are in US dollars and exclude applicable taxes
                </li>
                <li>Refunds are provided for undeliverable mail pieces only</li>
                <li>
                  We reserve the right to change pricing with 30 days' notice
                </li>
              </ul>
              <p className="text-gray-700 leading-relaxed">
                If payment is not received or is declined, we may suspend or
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed">
                We will make reasonable efforts to minimize downtime and provide
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed">
                You agree to indemnify, defend, and hold harmless Enclosed.AI
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed">
                We may also suspend or terminate your access immediately if you
                violate these Terms or engage in fraudulent or illegal
                activities.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed">
                Notwithstanding the foregoing, we may seek injunctive relief in
                any court of competent jurisdiction to prevent unauthorized use
                of our Service or intellectual property.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                entire agreement between you and Enclosed.AI regarding the use
                of the Service.
              </p>
            ...
            <section className="mb-12">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="text-gray-700 mb-2">
                  <strong>Email:</strong> legal@enclosed.ai
                </p>
                <p className="text-gray-700 mb-2">
                ...
                <p className="text-gray-700">
                  <strong>General Inquiries:</strong> support@enclosed.ai
                </p>
              </div>
            </section>
          </Prose>
