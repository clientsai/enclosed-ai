          ...
          <div className="bg-black rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-lg p-8 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/campaigns/new"
                  className="inline-flex items-center px-6 py-3 bg-black text-green-600 font-semibold rounded-lg hover:bg-black transition-colors"
                >
                  Create Personalized Campaign
                </Link>
                <Link
                  href="/help/campaigns"
                  className="inline-flex items-center px-6 py-3 border border-white text-white font-semibold rounded-lg hover:bg-black hover:text-green-600 transition-colors"
                >
